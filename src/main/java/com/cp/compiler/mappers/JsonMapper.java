...
public class JsonMapper {
  ...
  public static String transform(String jsonRequest, CompilerService compilerService)
      throws IOException, CompilerServerException {
    Request request = JsonMapper.toRequest(jsonRequest);
    ResponseEntity<Object> responseEntity = compilerService.compile(request.getSourceCode(), request.getTimeLimit(),
